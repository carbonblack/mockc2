...
const (
	...
	opDirectoryList              = 0x5
	opFileUpload                 = 0x7
	opFileUploadResp             = 0x8
	opFileDownload               = 0x9
	opFileDownloadData           = 0xa
	opFileCopy                   = 0xb
	opFileMove                   = 0xd
	opFileRename                 = 0xf
	opFileDelete                 = 0x11
	opDirectoryCreate            = 0x13
	opTimestomp                  = 0x15
	opProcessList                = 0x17
	opProcessKill                = 0x19
	opServiceList                = 0x1b
	...
	opServiceStop                = 0x1f
	opCommandPipe                = 0x21
	opCommandPipeResp            = 0x22
	opLibraryLoad                = 0x23
	opLibraryUnload              = 0x25
	opFileSize                   = 0x28
	opFileDownloadComplete       = 0x2a
	opScreenshot                 = 0x2b
	opMicrophoneCapture          = 0x2d
	opKeylogger                  = 0x2f
	opBrowserActivity1           = 0x31
	opCachePassword              = 0x33
	opDisconnect                 = 0x35
	opBrowserActivity2           = 0x42
	opError                      = 0x46
	opLogGet                     = 0x50
	opFileDownloadSize           = 0x53
	opWebcamCapture              = 0x54
	opUninstall                  = 0x58
	opWindowsList                = 0x59
)
